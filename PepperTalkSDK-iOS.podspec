#
#  Be sure to run `pod spec lint PepperTalkSDK-iOS.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/Espreccino/PepperTalkSDK-iOS.git", :tag => s.version.to_s }
  ...
  s.public_header_files = 'PepperTalk.embeddedframework/PepperTalk.framework/Versions/A/Headers/*.h'
  ...
  s.resources = ['PepperTalk.embeddedframework/Resources/PepperTalkResources.bundle', "Dependencies Resources/**/*.png", "Dependencies Resources/**/*.nib", "Dependencies Resources/**/*.json"]
  s.vendored_frameworks  = 'PepperTalk.embeddedframework/PepperTalk.framework'
